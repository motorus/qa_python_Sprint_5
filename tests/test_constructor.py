...
class TestConstructor:
    ...
    def test_jump_to_buns_success(self, get_logged_driver):
        ...
        button_sauces.click()
        button_buns.click()
        assert 'current' in button_buns.find_element(By.XPATH, '..').get_attribute('class')
    ...
    def test_jump_to_sauces_success(self, get_logged_driver):
        ...
        button_sauces = driver.find_element(*Locators.BUTTON_SAUCES)
        button_sauces.click()
        assert 'current' in button_sauces.find_element(By.XPATH, '..').get_attribute('class')
    ...
    def test_jump_to_fillings_success(self, get_logged_driver):
        ...
        assert 'current' in button_fillings.find_element(By.XPATH, '..').get_attribute('class')
